<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GAMING CHAIRS.aspx.cs" Inherits="TechFix.GAMING_CHAIRS" %>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/Asus SL301.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Asus SL301C ROG Chariot X</h4>
                        <p>GAMING CHAIRS <span class="condition">Brand New</span></p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/MSI MAG .png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>MSI MAG CH120 X GAMING CHAIR</h4>
                              <p>GAMING CHAIRS <span class="condition">Brand New</span></p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/FANTECH ALPHA.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>FANTECH ALPHA GC-283 GAMING CHAIR</h4>
                  <p>GAMING CHAIRS <span class="condition">Brand New</span></p>
                  <p class="price">₨68,500.00</p>
