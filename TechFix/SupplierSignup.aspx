<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierSignup.aspx.cs" Inherits="TechFix.SupplierSignup" %>
...
<div class="login-container">
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        ...
        <asp:ListItem>Supplier02</asp:ListItem>
         <asp:ListItem>Supplier03</asp:ListItem>
            </asp:DropDownList>
</div><br />
        <div class="form-group">
            <asp:Button ID="btnLogin" runat="server" Text="Login" CssClass="login-button" OnClick="btnLogin_Click"  />
        </div>
        <p>Already have an account? <a href="SupplierLogin.aspx">Logging here</a></p>
