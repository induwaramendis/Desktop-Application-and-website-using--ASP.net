<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MotherBoards.aspx.cs" Inherits="TechFix.MotherBoards" %>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/ASUS ROG MAXIMUS.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>ASUS ROG MAXIMUS Z790 DARK HERO</h4>
                        <p>MotherBoards <span class="condition">Brand New</span></p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/ASUS ROG STRIX.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>ASUS ROG STRIX Z790-F GAMING WIFI II</h4>
                              <p>MotherBoards <span class="condition">Brand New</span></p>
                                 <p class="price">₨190,000.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/ASUS PRIME Z790-P.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>ASUS PRIME Z790-P CSM WIFI DDR5</h4>
                  <p>MotherBoards <span class="condition">Brand New</span></p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/ASUS PRIME H510M.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>ASUS PRIME H510M-K</h4>
                  <p>MotherBoards <span class="condition">Brand New</span></p>
                  <p class="price">₨32,500.00</p>
