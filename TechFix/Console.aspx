<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Console.aspx.cs" Inherits="TechFix.Console___Handheld_Gaming" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Console & Handheld Gaming</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="breadcrumb">
            <p>Home / Console & Handheld Gaming</p>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/Lenovo legionco.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Lenovo Legion Go | 8APU1 Ryzen Z1| AMD Ryzen Z1 Extreme</h4>
                        <p>Console & Handheld Gaming, Lenovo <span class="condition">Brand New</span></p>
                        <p class="price"> ₨349,000.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/XBOX.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>XBOX Wireless Headset</h4>
                              <p>Console & Handheld Gaming, Xbox <span class="condition">Brand New</span></p>
                                 <p class="price">₨38,500.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/nintendo.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>Nintendo Switch OLED Model - Neon </h4>
                  <p>Console & Handheld Gaming, Switch <span class="condition">Brand New</span></p>
    ...
    <div class="product-badge flash-deal">Flash Deal</div>
        <div class="product-img">
            <img src="images/playstation-5.png" alt="HP Victus 15">
        </div>
       <div class="product-info">
               <h4>PLAYSTATION 5 SLIM DISK EDITION CONSOLE </h4>
                     <p>Console & Handheld Gaming <span class="condition">Brand New</span></p>
                     <p class="price">₨195,000.00</p>
