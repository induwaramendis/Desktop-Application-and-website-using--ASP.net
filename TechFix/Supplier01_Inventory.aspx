<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier01_Inventory.aspx.cs" Inherits="TechFix.Supplier01_Inventory" %>
...
<body>
 ...
 <asp:Button ID="LogoutButton" runat="server" Text="Logout" BackColor="Red" Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="44px" Width="114px" OnClick="LogoutButton_Click"   />
    ...
    <img src='<%# ResolveUrl("~/s1inventory/" + Eval("Image")) %>' alt='Product Image' width='100'/>
     ...
     <button><a href="S1Inventory.aspx" >Go</a></button>
 </div><br />

         <div class="card">
    
    <h2>Admin Inventory</h2>
    <button><a href="AddedInvenSup01.aspx" >Go</a></button>
</div>
