<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Messages.aspx.cs" Inherits="TechFix.Messages" %>
    ...
    <section class="contact">
       ...
       <center> <form id="contactForm" runat="server" onsubmit="ContactSubmit">
               ...
               <!-- <asp:TextBox ID="billnum" runat="server" MaxLength="50" CssClass="box" placeholder="Enter your bill number" required="required" />-->
                ...
                <asp:TextBox ID="txtmsg" runat="server" TextMode="MultiLine" Rows="10" Columns="30" MaxLength="500" CssClass="box" placeholder="Enter your Message" required="required" />
                <asp:Button ID="sendButton" runat="server" Text="Send Message" CssClass="btn" OnClick="sendButton_Click" BackColor="Red" BorderColor="White" Font-Size="Large" ForeColor="White" Height="50px" Width="200px"  />
