<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supplier02_Inventory.aspx.cs" Inherits="TechFix.Supplier02_Inventory" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Supplier 02 Inventory</title>
        <style>
  body {
...
.user-icon {
 ...
 <asp:Button ID="LogoutButton" runat="server" Text="Logout" BackColor="Red" Font-Bold="True" Font-Size="Medium" ForeColor="White" Height="44px" Width="114px" OnClick="LogoutButton_Click"   />
    ...
    <button><a href="S2Inventory.aspx" >Go</a></button>
</div><br />
    ...
    <button><a href="AddedInvenSup02.aspx" >Go</a></button>
</div>
</body>
