<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MONITORS_ACCESSORIES.aspx.cs" Inherits="TechFix.MONITORS___ACCESSORIES" %>
...
<head runat="server">
    <title>MONITORS & ACCESSORIES</title>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/ASUS ROG Strix XG49VQ.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>ASUS ROG Strix XG49VQ Super Ultra-Wide HDR Gaming Monitor 49" (3840 x 1080), 144Hz</h4>
                        <p>MONITORS & ACCESSORIES <span class="condition">Brand New</span></p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Koorui N07.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Koorui N07 27" UHD 4K IPS DCI-P3 90% HDR10</h4>
                              <p>MONITORS & ACCESSORIES <span class="condition">Brand New</span></p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/Koorui GN07 27.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>Koorui GN07 27" 2K QHD 2560 x 1440 IPS 170HZ SRGB 100%</h4>
                  <p>MONITORS & ACCESSORIES <span class="condition">Brand New</span></p>
                  <p class="price">₨69,000.00</p>
