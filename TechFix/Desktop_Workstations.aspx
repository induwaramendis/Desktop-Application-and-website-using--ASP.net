<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Desktop_Workstations.aspx.cs" Inherits="TechFix.Desktop_Workstations" %>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/Nano-x.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Nano-X Photographer & Gaming Ryzen</h4>
                        <p>Desktop Workstations <span class="condition">Brand New</span></p>
                        <p class="price"> ₨109,500.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Nano-X Director PRO.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Nano-X Director PRO</h4>
                              <p>Desktop Workstations <span class="condition">Brand New</span></p>
                                 <p class="price">₨312,000.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/NANO-X CREATOR V2.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>NANO-X CREATOR V2</h4>
                  <p>Desktop Workstations <span class="condition">Brand New</span></p>
                  <p class="price">₨520,000.00</p>
    ...
    <div class="product-badge flash-deal">Flash Deal</div>
        <div class="product-img">
            <img src="images/NANO-X CREATOR PRO V2.png" alt="HP Victus 15">
        </div>
       <div class="product-info">
               <h4>NANO-X CREATOR PRO V2 (AMD RYZEN 7000 SERIES) </h4>
                     <p>Desktop Workstations<span class="condition">Brand New</span></p>
