<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Processors.aspx.cs" Inherits="TechFix.Processors" %>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/AMD Ryzen 9 .png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>AMD Ryzen 9 9950X (up to 5.7Ghz 16-cores 32-threads) 64M Cache</h4>
                        <p>Processors <span class="condition">Brand New</span></p>
                        <p class="price"> ₨232,000.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Intel Core i9.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Intel Core i9 14900KS (36M Cache, up to 6.20 GHz)</h4>
                              <p>Processors <span class="condition">Brand New</span></p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/Intel Cor.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>Intel Core i7 14700K (33M Cache, up to 5.60 GHz)</h4>
                  <p>Processors <span class="condition">Brand New</span></p>
                  <p class="price">₨137,500.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/AMD Ryzen 5.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>AMD Ryzen 5 8600G up to 5Ghz 6-cores 12-threads) 16M Cache</h4>
                  <p>Processors <span class="condition">Brand New</span></p>
