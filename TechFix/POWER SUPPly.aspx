<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POWER SUPPly.aspx.cs" Inherits="TechFix.POWER_SUPPly" %>
...
<head runat="server">
    <title>POWER SUPPLY, UPS & SURGE PROTECTORS</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div class="breadcrumb">
            <p>Home / POWER SUPPLY, UPS & SURGE PROTECTORS</p>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/Asus ROG THOR.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Asus ROG THOR 1600W Titanium Full Modular</h4>
                        <p>POWER SUPPLY, UPS & SURGE PROTECTORS <span class="condition">Brand New</span></p>
                        <p class="price"> ₨265,000.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Asus ROG STRIX 1000W .png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Asus ROG STRIX 1000W Gold Aura Edition</h4>
                              <p>POWER SUPPLY, UPS & SURGE PROTECTORS <span class="condition">Brand New</span></p>
                                 <p class="price">₨99,000.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/Corsair .png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>Corsair RMe Series RM1000e Fully Modular 80+ GOLD</h4>
                  <p>POWER SUPPLY, UPS & SURGE PROTECTORS <span class="condition">Brand New</span></p>
                  <p class="price">₨67,500.00</p>
