<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Budget_Desktop_Computers.aspx.cs" Inherits="TechFix.Budget_Desktop_Computers" %>
...
<head runat="server">
    <title>Budget Desktop Computers</title>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/Intel NanoDesk Mid Core i3.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Intel NanoDesk Mid Core i3</h4>
                        <p>Budget Desktop Computers <span class="condition">Brand New</span></p>
                        <p class="price"> ₨98,000.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Intel NanoDesk PRO Core i5.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Intel NanoDesk PRO Core i5</h4>
                              <p>Budget Desktop Computers <span class="condition">Brand New</span></p>
                                 <p class="price">₨110,000.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/INTEL NANODESK EXTREME Core i7.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>INTEL NANODESK EXTREME Core i7</h4>
                  <p>Budget Desktop Computers <span class="condition">Brand New</span></p>
                  <p class="price">₨182,500.00</p>
