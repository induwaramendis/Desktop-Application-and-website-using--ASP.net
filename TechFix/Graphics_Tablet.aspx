<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Graphics_Tablet.aspx.cs" Inherits="TechFix.Graphics_Tablet" %>
...
<head runat="server">
    <title>Graphics Tablet / Tab</title>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/husion.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>Huion HS64 Pen Tablet</h4>
                        <p>Graphics Tablet / Tab <span class="condition">Brand New</span></p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Wacom.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>Wacom Intuos Pro Small Pen & Touch Tablet</h4>
                              <p>Graphics Tablet / Tab <span class="condition">Brand New</span></p>
                                 <p class="price">₨99,500.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/WACOM_ONE_01.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>Wacom One Creative Pen Display 13" - DTC133 </h4>
                  <p>Graphics Tablet / Tab <span class="condition">Brand New</span></p>
                  <p class="price">₨159,000.00</p>
    ...
    <div class="product-badge flash-deal">Flash Deal</div>
        <div class="product-img">
            <img src="images/wacom2.png" alt="HP Victus 15">
        </div>
       <div class="product-info">
               <h4>Wacom Drawing Glove </h4>
                     <p>Graphics Tablet / Tab<span class="condition">Brand New</span></p>
