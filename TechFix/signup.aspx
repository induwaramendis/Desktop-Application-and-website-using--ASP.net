<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="signup.aspx.cs" Inherits="TechFix.signup" %>
...
<div class="login-container">
    <form id="loginForm" runat="server">
       ...
       <asp:TextBox ID="txtEmail" runat="server" CssClass="form-control" required="required"></asp:TextBox>
        ...
        <div class="form-group">
            <asp:Button ID="btnLogin" runat="server" Text="Signup" CssClass="login-button" OnClick="btnLogin_Click"  />
        </div>
        <p>Already have an account? <a href="Login Page.aspx">Logging here</a></p>
