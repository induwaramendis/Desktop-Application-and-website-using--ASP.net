<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Memory (RAM).aspx.cs" Inherits="TechFix.Memory__RAM_" %>
...
<li><a href="Desktop_Workstations.aspx">Desktop Workstations</a></li>
            ...
            <div class="product-grid">
                <div class="product-card">
                    ...
                    <div class="product-img">
                        <img src="images/CORSAIR DOMINATOR TITANIUM.png" alt="HP Victus 15">
                    </div>
                    <div class="product-info">
                        <h4>CORSAIR DOMINATOR TITANIUM RGB AMD & Intel 64GB (2X32GB) DDR5 6000MHZ</h4>
                        <p>Memory (RAM) <span class="condition">Brand New</span></p>
                        <p class="price"> ₨108,000.00</p>
                 ...
                 <div class="product-card">
                    <div class="product-badge flash-deal">Flash Deal</div>
                         <div class="product-img">
                              <img src="images/Vulcan DDR5.png" alt="HP Victus 15">
                         </div>
                      <div class="product-info">
                          <h4>TEAM TFORCE VULCAN 32GB D5 INTEL 5600MHZ - BLK</h4>
                              <p>Memory (RAM) <span class="condition">Brand New</span></p>
                                 <p class="price">₨35,500.00</p>
 ...
 <div class="product-badge flash-deal">Flash Deal</div>
     <div class="product-img">
         <img src="images/DELTA TUF RGB.png" alt="HP Victus 15">
     </div>
    <div class="product-info">
            <h4>TEAM TFORCE DELTA RGB 48GB (24X2) 6400MHZ</h4>
                  <p>Memory (RAM) <span class="condition">Brand New</span></p>
                  <p class="price">₨79,000.00</p>
